...
if __name__ == '__main__':
    ...
    argparser.add_argument('--root_dir', type=str, default='preprocessing/20240502_BphP_cylinders_noise_std2/')
    ...
    argparser.add_argument('--wandb_notes', type=str, default='noise_std2')
